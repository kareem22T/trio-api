...
<div class="card p-3 mb-3" id="works_wrapper">
    ...
    <div class="form-group">
        <br>
        <button class="btn btn-success w-25" @click="updateWork" style="margin: auto; display: block">Create</button>
    </div>
</div>
...
createApp({
    ...
    methods: {
        ...
        async updateWork() {
            ...
            try {
                const response = await axios.post(`{{ route("admin.works.create") }}`, {
                    title: this.title,
